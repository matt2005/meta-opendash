...
SRC_URI = "git://github.com/opendsh/dash.git;protocol=https;branch=develop \
           ...
           "
SRCREV = "develop"
DEPENDS += " qt-gstreamer libpthread-stubs cmake protobuf protobuf-native aasdk pulseaudio taglib librtaudio qtmultimedia qtconnectivity gcc-runtime gstreamer1.0 gstreamer1.0-plugins-base qt-gstreamer boost aasdk openauto"
inherit cmake_qt5
EXTRA_OECONF += " \
    --enable-pthreads \
