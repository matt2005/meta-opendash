...
SRCREV = "develop"
DEPENDS += " libpthread-stubs cmake protobuf protobuf-native aasdk pulseaudio pkgconfig taglib librtaudio qtmultimedia qtconnectivity qtserialbus qtwebsockets dbus gcc-runtime gstreamer1.0 gstreamer1.0-plugins-base gstreamer1.0-plugins-good qt-gstreamer boost bluez-qt aasdk openauto xrandr"
inherit cmake_qt5
EXTRA_OECONF += " \
    --enable-pthreads \
